...
void loop()
{
  ...
  if(bypass)
  {
    ...
    Serial.println("bypass true");

  }
  else {
    Serial.println("bypass false");
...
void currentMeasurement()
{
  ...
  Serial.print("weerstandspanning = ");
...
void AverageFilterCurrent()
{
  ...
  Serial.print("spanningOverWeerstand is ");
...
void AverageFilterCurrentRichting()
{
  ...
  Serial.print("current richting = "); 
  Serial.println(average);
  Serial.print("IsCharching = "); 
